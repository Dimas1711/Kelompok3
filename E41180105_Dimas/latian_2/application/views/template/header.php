    ...
    <div id="home" class="slider-area">
      <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides">
          <img src="<?php echo base_url("gambar/1.jpg");?>" alt="" title="#slider-direction-1" />
          <img src="<?php echo base_url("gambar/2.jpg");?>" alt="" title="#slider-direction-2" />
          <img src="<?php echo base_url("gambar/3.jpg");?>" alt="" title="#slider-direction-3" />
        </div>
      </div>
    </div>
